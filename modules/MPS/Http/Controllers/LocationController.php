...
class LocationController extends Controller
{
    ...
    public function store(LocationRequest $request)
    {
        ...
        cache()->pull('mps_locations');
        $locations = locations(['id as value', 'name as label', 'color', 'logo']);
        return response(['success' => true, 'data' => $location, 'locations' => $locations]);
    }
    ...
    public function update(LocationRequest $request, Location $location)
    {
        ...
        cache()->pull('mps_locations');
        $locations = locations(['id as value', 'name as label', 'color', 'logo']);
        return response(['success' => $updated, 'data' => $location->refresh(), 'locations' => $locations]);
    }
}
