...
class ItemRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            // 'portions.*.choosables'            => 'array|min:1|required_if:type,recipe',
            // 'portions.*.choosables.*.item_id'  => 'required_if:type,recipe',
            // 'portions.*.choosables.*.quantity' => 'required_if:type,recipe',
        ];
    }
