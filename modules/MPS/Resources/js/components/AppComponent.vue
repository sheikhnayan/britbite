              ...
              <Menu :theme="theme" class="top-menu" mode="horizontal" @on-select="onSelect" :active-name="activeMenu" v-if="user">
                <div class="layout-nav">
                  ...
                  <Submenu name="4">
                    ...
                    <MenuItem v-if="$store.getters.customer || $store.getters.supplier" to="/company">
                      <Icon type="md-person" size="16" />
                      {{ $tc('company') }}
                    </MenuItem>
                    <MenuItem name="profile">
            ...
            <Layout :class="{ 'mhvh-50': $store.getters.fixed_layout == 1 }">
              <Content class="content">
                ...
                >
                  ...
                  <template slot="desc">
                    You can
                    <a target="_blank" href="https://github.com/Tecdiary/mps-guide/discussions/new?category=q-a"> ask question</a>,
                    <a target="_blank" href="https://github.com/Tecdiary/mps-guide/issues/new?labels=bug">
                      report bug/error
                    </a>
                    and
                    <a target="_blank" href="https://github.com/Tecdiary/mps-guide/discussions/new?category=ideas">
                      request feature/report</a
                    >
                  </template>
                </Alert>
                <transition
              ...
              <Footer class="layout-footer-center" style="padding: 16px 20px;">
                ...
                <div class="version float-right">
                  Version {{ version }}
                  <small>
                    <a href="https://tecdiary.github.io/mps-guide/" target="_blank">
