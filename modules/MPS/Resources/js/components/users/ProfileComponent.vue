    ...
    <Card :dis-hover="true">
      ...
      <span slot="extra">
        ...
        <Button
          ...
          v-if="!$store.getters.superAdmin && !$store.getters.customer && !$store.getters.supplier"
        >
            ...
            <Col :sm="24" :md="24" :lg="24">
              ...
              <Row :gutter="16">
                <Col :sm="24" :md="12" :lg="12">
                  ...
                  <template v-if="$store.getters.customer">
                ...
                <Col :sm="24" :md="12" :lg="12">
                  <template v-if="!$store.getters.customer && !$store.getters.supplier">
                    <FormItem :label="$t('email')" prop="email" :error="errors.form.email | a2s">
                      <Input readonly v-model="form.email" />
                    </FormItem>
                  </template>
              ...
              <FormItem :label="$t('theme')" prop="theme" :class="$store.getters.customer || $store.getters.supplier ? '' : 'mb0'">
              ...
              <FormItem v-if="!$store.getters.customer && !$store.getters.supplier" prop="play_sound">
