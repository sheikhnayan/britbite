...
export const customer = state => {
  return state.user && (state.user.customer_id || (state.user.roles.length && state.user.roles.find(r => r.name == 'customer')))
    ? true
    : false;
};
export const supplier = state => {
  return state.user && (state.user.supplier_id || (state.user.roles.length && state.user.roles.find(r => r.name == 'supplier')))
    ? true
    : false;
};
