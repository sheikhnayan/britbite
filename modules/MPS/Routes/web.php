...
// Commands for the storage and migration
Route::middleware('role:super')->group(function () {
    Route::get('/commands/storage_link', function () {
        Artisan::call('storage:link');
        return redirect('welcome')->with('message', Artisan::output());
    });
    Route::get('/commands/update_database', function () {
...
Route::prefix($route)->group(function () {
    ...
    Route::prefix('app')->group(function () {
        ...
        Route::middleware('auth')->group(function () {
            ...
            Route::get('user/company', 'UserCompanyController@show');
            Route::post('user/company', 'UserCompanyController@update');
            ...
            // Customer/Supplier addresses & users
            ...
            Route::post('suppliers/add_user', 'SupplierController@addUser')->name('suppliers.users.add');
            Route::get('customers/users/{customer_id}', 'CustomerController@users')->name('customers.users');
            Route::get('suppliers/users/{supplier_id}', 'SupplierController@users')->name('suppliers.users');
            ...
            Route::put('suppliers/update_user/{user}', 'SupplierController@updateUser')->name('suppliers.users.update');
            Route::get('customers/addresses/{customer_id}', 'CustomerController@addresses')->name('customers.addresses');
            Route::delete('customers/delete_user/{user}', 'CustomerController@deleteUser')->name('customers.users.delete');
            Route::delete('suppliers/delete_user/{user}', 'SupplierController@deleteUser')->name('suppliers.users.delete');
            Route::put('customers/update_address/{address}', 'CustomerController@updateAddress')->name('customers.addresses.update');
            Route::delete('customers/delete_address/{address}', 'CustomerController@deleteAddress')->name('customers.addresses.delete');
